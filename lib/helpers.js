...
class RemoteControl extends Sensor {
	constructor(namespace,name,address,desc) {
		...
		this.states.push(new State(namespace + '.' + name,'onTurnOn','number','',false));
		this.states.push(new State(namespace + '.' + name,'onTurnOff','number','',false));
		this.states.push(new State(namespace + '.' + name,'onExecuteScenario','number','',false));
		this.states.push(new State(namespace + '.' + name,'onSaveScenario','number','',false));
		this.states.push(new State(namespace + '.' + name,'onStopReq','number','',false));
		this.states.push(new State(namespace + '.' + name,'onRollColour','number','',false));
		this.states.push(new State(namespace + '.' + name,'onSwitchColour','number','',false));
		this.states.push(new State(namespace + '.' + name,'onSwitch','string','number',false));
		this.states.push(new State(namespace + '.' + name,'onSensTempHumi','number','',false));
	}
	getTypeCode()  {
		return 0;
	}
